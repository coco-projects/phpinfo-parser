<?php
    ...
    namespace Coco\phpinfoParser\Parsers;

    use Coco\phpinfoParser\Collections\Lines;
    use Coco\phpinfoParser\Models\Config;
    use Coco\phpinfoParser\Models\Group;
...
class TextParser extends Result
{
    ...
    {
        return str_contains(str_replace("\r\n", "\n", $contents), "phpinfo()\nPHP Version") && count(explode("_______________________________________________________________________", $contents)) >= 2;
    }
